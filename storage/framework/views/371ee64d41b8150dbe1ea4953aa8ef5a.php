...
<head>
    <meta charset="UTF-8">
    <title>Struk Pembayaran #<?php echo e($transaction->id); ?></title>
    <style>
...
<div class="struk">
    ...
    <div class="row-item">
        ...
        <span>#<?php echo e(str_pad($transaction->id, 5, '0', STR_PAD_LEFT)); ?></span>
    </div>
    <div class="row-item">
    ...
    <div class="row-item">
        ...
        <span><?php echo e($transaction->created_at->format('H:i')); ?> WIB</span>
    </div>
    <div class="row-item">
    ...
    <div class="row-item">
        ...
        <span><?php echo e($transaction->service->name); ?></span>
    </div>
    <div class="row-item">
        <span class="label">Harga Satuan</span>
        <span>Rp <?php echo e(number_format($transaction->service->price, 0, ',', '.')); ?></span>
    </div>
    <div class="row-item">
    <span class="label">Orang</span>
    <span><?php echo e($transaction->qty); ?> orang</span>
</div>
...
<?php /**PATH C:\SEMESTER 4\PENGUJIAN\-Kasir-Barbershop\resources\views/transactions/struk.blade.php ENDPATH**/ ?>